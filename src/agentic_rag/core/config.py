...
class Settings:
    ...
    deepseek_timeout_seconds: float = float(os.getenv("DEEPSEEK_TIMEOUT_SECONDS", "300"))
    deepseek_max_retries: int = int(os.getenv("DEEPSEEK_MAX_RETRIES", "4"))
    deepseek_retry_base_delay_seconds: float = float(os.getenv("DEEPSEEK_RETRY_BASE_DELAY_SECONDS", "1.0"))
    deepseek_retry_max_delay_seconds: float = float(os.getenv("DEEPSEEK_RETRY_MAX_DELAY_SECONDS", "8.0"))
